...
public class TaskServiceImpl implements TaskService {
    ...
    public TaskRecord getOneTaskById(Long id) throws TaskException{
        ...
        if (task==null){
            throw new TaskException(Constant.TASK_NOT_EXIST, HttpStatus.NOT_FOUND);
        }else{
    ...
    public void createTask(Long id_user, TaskRecord newTask) throws TaskException{
    ...
    public void updateTask(TaskRecord newDataTask) throws TaskException{
        Task task=taskRepository.findById(newDataTask.id()).orElse(null);
        if (task==null){
            throw new TaskException(Constant.TASK_NOT_EXIST, HttpStatus.NOT_FOUND);
        }else{
