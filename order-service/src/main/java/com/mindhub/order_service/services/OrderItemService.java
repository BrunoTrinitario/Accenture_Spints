...
public interface OrderItemService {
    ...
    OrderItemRecord addOrderItem(NewOrderItemRecord newOrderItem) throws OrderException, OrderItemException;
    void deleteOrderItem(Long id) throws OrderException, OrderItemException;
    OrderItemRecord updateOrderItem(Long id, Integer quantity) throws OrderItemException;
