        ...
        http
                ...
                .authorizeHttpRequests( authorizeRequests ->
                        authorizeRequests
                                ...
                                .requestMatchers("/API/user/**").hasAnyAuthority(UserRoles.USER.toString(),UserRoles.ADMIN.toString())
                                .requestMatchers("/API/task/**").hasAnyAuthority(UserRoles.USER.toString(),UserRoles.ADMIN.toString())
                                .requestMatchers("/API/admin/**").hasAuthority(UserRoles.ADMIN.toString())
                                .anyRequest().denyAll()
                )
                .headers(
